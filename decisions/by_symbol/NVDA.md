...
- Decision file: `decisions/2026-07-03/2042_NVDA.json`
...
- **Outcome: STILL UNRESOLVED / DEFERRED (2nd consecutive week).** No trustworthy fresh daily close printed anywhere in W28 — the primary daily-bar feed (yfinance TLS-blocked; Alpaca IEX daily bars) stayed anchored to ~2026-06-23 all five sessions (`journals/daily/2026-07-10.md` pre-market: bars end 06-23, ~11–16 trading days stale). The post-exit reclaim question cannot be confirmed on stale bars; carried forward to ≥ 2026-07-13 (W29). NVDA not held (closed 2026-07-01).
- Note: NVDA's stale-bar ENTRY re-fires in W28 (07-10 pre-market scan placed it at the rank 6–7 buffer (dropped out of top-5 on the 07-10 stale-bar scan, reverse of 07-09)) were computed on ~06-23 bars and gated NO_TRADE at every EOD under CLAUDE.md rule #5; they do not constitute fresh confirmation of rank or trend. This block records the prediction status only — no new trade.

## 2026-07-19 — weekly_review self_learning: prediction reconciliation (W29)
- Carries the W27 open item: "the 2026-07-01 stop exit proves durable — price continues below the stop and does not whipsaw back."
- **Outcome: STILL UNRESOLVED / DEFERRED (3rd consecutive week).** No trustworthy fresh daily close printed anywhere in W29 — the daily-bar feed (yfinance TLS-blocked ~22d; Alpaca IEX daily bars) stayed anchored to ~2026-06-29 all five sessions (`journals/daily/2026-07-17.md` pre-market: bars end 06-29, ~17d stale). The post-exit reclaim question cannot be confirmed on stale bars; carried forward to the next fresh close (≥ 2026-07-20). NVDA not held (closed 2026-07-01). This block records the prediction status only — no new trade.
